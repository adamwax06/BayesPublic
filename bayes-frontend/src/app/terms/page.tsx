      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-8">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <p>
              The website located at www.trybayes.com (the “Site”) is a
              copyrighted work belonging to Bayes AI, Inc. (“Company”, “us”,
            ...
            <p>
              PLEASE BE AWARE THAT SECTION 10.2 CONTAINS PROVISIONS GOVERNING
              HOW TO RESOLVE DISPUTES BETWEEN YOU AND COMPANY. AMONG OTHER
              THINGS, SECTION 10.2 INCLUDES AN AGREEMENT TO ARBITRATE WHICH
              ...
              10.2 ALSO CONTAINS A CLASS ACTION AND JURY TRIAL WAIVER. PLEASE
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold mb-2">2.1 License.</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold mb-2">2.3 Modification.</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold mb-2">2.5 Ownership.</h3>
              <p>
                Excluding any User Content that you may provide (defined below),
                you acknowledge that all the intellectual property rights,
                including copyrights, patents, trade marks, and trade secrets,
                in the Site and its content are owned by Company or Company’s
              ...
              <h3 className="text-xl font-semibold mb-2">2.6 Feedback.</h3>
              <p>
                If you provide Company with any feedback or suggestions
                regarding the Site (“Feedback”), you hereby assign to Company
                all rights in such Feedback and agree that Company shall have
                the right to use and fully exploit such Feedback and related
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold mb-2">3.1 User Content.</h3>
              <p>
                ...
                in any way provided, sponsored or endorsed by Company. Since you
              ...
              <p>
                ...
                of the Site; or (vii) use software or automated agents or
              ...
              <h3 className="text-xl font-semibold mb-2">3.4 Enforcement.</h3>
              <p>
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold mb-2">5.2 Other Users.</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold mb-2">5.3 Release.</h3>
              <p>
                ...
                any Third-Party Links & Ads). IF YOU ARE A CALIFORNIA RESIDENT,
                YOU HEREBY WAIVE CALIFORNIA CIVIL CODE SECTION 1542 IN
                CONNECTION WITH THE FOREGOING, WHICH STATES: “A GENERAL RELEASE
                DOES NOT EXTEND TO CLAIMS WHICH THE CREDITOR OR RELEASING PARTY
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold mb-2">9.1 Changes.</h3>
              <p>
              ...
              <p>
                ...
                the manner in which you can seek relief from the Company
                Parties.
              </p>
              <p>
                (a) Applicability of Arbitration Agreement. You agree that any
                dispute between you and any of the Company Parties relating in
                any way to the Site, the services offered on the Site (the
                “Services”) or these Terms will be resolved by binding
                ...
                solely on an individual, non-class basis; and (2) you or the
                Company Parties may seek equitable relief in court for
                ...
                asserted before you agreed to these Terms (in accordance with
                the preamble) or any prior version of these Terms. This
                Arbitration Agreement does not preclude you from bringing issues
                to the attention of federal, state or local agencies. Such
                ...
                prior versions of the Agreement as well as claims that may arise
                after the termination of these Terms.
              </p>
              <p>
                (b) Informal Dispute Resolution. There might be instances when a
                Dispute arises between you and Company. If that occurs, Company
                is committed to working with you to reach a reasonable
                resolution. You and Company agree that good faith informal
                efforts to resolve Disputes can result in a prompt, low‐cost and
                mutually beneficial outcome. You and Company therefore agree
                that before either party commences arbitration against the other
                (or initiates an action in small claims court if a party so
                elects), we will personally meet and confer telephonically or
                via videoconference, in a good faith effort to resolve
              ...
              <p>
                ...
                Resolution Conference (“Notice”), which shall occur within 45
                days after the other party receives such Notice, unless an
                extension is mutually agreed upon by the parties. Notice to
                Company that you intend to initiate an Informal Dispute
                Resolution Conference should be sent by email to:
                founders@trybayes.com, or by regular mail to 131 Continental Dr,
                Suite 305, , , Newark, Delaware 19713. The Notice must include:
              ...
              <p>
                (c) Arbitration Rules and Forum. These Terms evidence a
                ...
                resolve satisfactorily within 60 days after receipt of your
                Notice, you and Company agree that either party shall have the
                right to finally resolve the Dispute through binding
                ...
                claims and counterclaims with an amount in controversy under
                ...
                at 800-352-5267. A party who wishes to initiate arbitration must
                ...
                statement of the legal claims being asserted and the factual
                bases of those claims; (3) a description of the remedy sought
                and an accurate, good‐faith calculation of the amount in
                controversy in United States Dollars; (4) a statement certifying
                completion of the Informal Dispute Resolution process as
                described above; and (5) evidence that the requesting party has
                paid any necessary filing fees in connection with such
                arbitration.
              </p>
              <p>
              ...
              <p>
                ...
                process discussed in Subsection 10.2(h) is triggered, the
              ...
              <p>
                ...
                authority to resolve all disputes subject to arbitration
                hereunder including, without limitation, any dispute related to
                the interpretation, applicability, enforceability or formation
                of this Arbitration Agreement or any portion of the Arbitration
                Agreement, except for the following: (1) all Disputes arising
                out of or relating to the subsection entitled “Waiver of Class
                or Other Non-Individualized Relief,” including any claim that
                all or part of the subsection entitled “Waiver of Class or Other
              ...
              <p>
                (e) Waiver of Jury Trial. EXCEPT AS SPECIFIED IN SECTION 10.2(A)
                YOU AND THE COMPANY PARTIES HEREBY WAIVE ANY CONSTITUTIONAL AND
                STATUTORY RIGHTS TO SUE IN COURT AND HAVE A TRIAL IN FRONT OF A
                JUDGE OR A JURY. You and the Company Parties are instead
                ...
                except as specified in Section 10.2(a) above. An arbitrator can
              ...
              <p>
                ...
                COMPANY AGREE THAT, EXCEPT AS SPECIFIED IN SUBSECTION 10.2(H)
                ...
                located in the State of Delaware. All other Disputes shall be
              ...
              <p>
                ...
                finds that either the substance of the Dispute or the relief
                sought in the Request was frivolous or was brought for an
                improper purpose (as measured by the standards set forth in
                Federal Rule of Civil Procedure 11(b)). If you or Company need
                to invoke the authority of a court of competent jurisdiction to
                ...
                securing an order compelling arbitration. The prevailing party
                in any court action relating to whether either party has
              ...
              <p>
                (h) Batch Arbitration. To increase the efficiency of
                administration and resolution of arbitrations, you and Company
                agree that in the event that there are 100 or more individual
                Requests of a substantially similar nature filed against Company
                by or with the assistance of the same law firm, group of law
                firms, or organizations, within a 30 day period (or as soon as
                possible thereafter), the JAMS shall (1) administer the
                arbitration demands in batches of 100 Requests per batch (plus,
                to the extent there are less than 100 Requests left over after
                the batching described above, a final batch consisting of the
              ...
              <p>
                (i) 30-Day Right to Opt Out. You have the right to opt out of
                the provisions of this Arbitration Agreement by sending a timely
                written notice of your decision to opt out to the following
                address: 131 Continental Dr, Suite 305, , , Newark, Delaware
                19713, or email to founders@trybayes.com, within 30 days after
                first becoming subject to this Arbitration Agreement. Your
                notice must include your name and address and a clear statement
                ...
                Terms will continue to apply to you. Opting out of this
                Arbitration Agreement has no effect on any other arbitration
                agreements that you may currently have with us, or may enter
                into in the future with us.
              </p>
              <p>
                (j) Invalidity, Expiration. Except as provided in the subsection
                entitled “Waiver of Class or Other Non-Individualized Relief”,
              ...
              <p>
                (k) Modification. Notwithstanding any provision in these Terms
                to the contrary, we agree that if Company makes any future
                ...
                writing Company at the following address: 131 Continental Dr,
                Suite 305, , , Newark, Delaware 19713, or email to
                founders@trybayes.com. Unless you reject the change within 30
              ...
              <h3 className="text-xl font-semibold mb-2">9.3 Export.</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold mb-2">9.4 Disclosures.</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold mb-2">9.6 Entire Terms.</h3>
              <p>
              ...
              <p>Nanda Guntupalli</p>
              <p>Address:</p>
              <p>131 Continental Dr</p>
              <p>Suite 305</p>
              <p>Newark, Delaware 19713</p>
              <p>Telephone: 6099375238</p>
              <p>
                Email:{" "}
                <a href="mailto:founders@trybayes.com">founders@trybayes.com</a>
              </p>
            </section>
          </div>
        </div>
