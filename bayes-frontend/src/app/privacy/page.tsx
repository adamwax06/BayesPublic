      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-8">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <p>
              Bayes AI, Inc. (the “Company”) is committed to maintaining robust
            ...
            <p>
              ...
              website, which can be accessed at https://trybayes.com or through
              our mobile application. “Service” refers to the Company's services
              accessed via the Site, in which users can get math tutoring. The
              ...
              (found here: /terms), and you consent to our collection, storage,
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                email, name, payment information, and educational preferences,
                which you submit to us through the registration process at the
                Site.
              </p>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                which may include: name, payment information, and educational
                preferences. However, in an effort to improve the quality of the
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                contact us at founders@trybayes.com.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                provided in each promotional e-mail. You can also indicate that
                you do not wish to receive marketing communications from us in
                the “Settings” section of the Site. Please note that
                notwithstanding the promotional preferences you indicate by
                either unsubscribing or opting out in the “Settings” of the
                Site, we may continue to send you administrative emails
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                changes to our Privacy Policy by sending a notice to the
                aprimary email address specified in your account or by placing a
